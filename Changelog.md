...
This is the latest version, which adds more interactive commands for managing configuration and settings, and improves the overall usability of the tool.
